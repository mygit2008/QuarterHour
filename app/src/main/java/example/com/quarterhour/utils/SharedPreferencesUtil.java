...
import static example.com.quarterhour.utils.IPreference.DataType.INTEGER;

public class SharedPreferencesUtil implements IPreference {
        ...
        private static synchronized void initPreference(Context context, String fileName){
            if (iPreference== null){
                iPreference= new SharedPreferencesUtil(context, fileName);
            }
        }
